...
export const PLACES: Place[] = [
  ...
  },
  {
    ...
    area: "Old city",
    details: [
      "Ottoman builders raised this miniature arch over the Radobolja stream eight years before Stari Most — the story goes that it was the rehearsal.",
      "A flood swept it away in 2000; it was rebuilt with the original stones recovered from the streambed.",
      "The mills and terraces around it are the coolest corner of the old city in August.",
    ],
  },
  {
    slug: "karadoz-bey-mosque",
    kicker: "Mosque",
    ...
    area: "Old city",
    details: [
      "Designed in the classical Ottoman style and considered the finest mosque in Herzegovina, with a single dome over a square prayer hall.",
      "Shelled heavily in 1992 – 93 and restored over the following decade; the painted interior decoration was redone from photographs.",
      "The courtyard, fountain, and old cemetery sit just off Braće Fejića, five minutes from the bazaar.",
    ],
  },
  {
    slug: "biscevic-house",
    ...
    area: "Old city",
    details: [
      "The divanhana — the raised sitting room — hangs five metres above the water on stone corbels.",
      "Still owned by the same family, with original chests, copper, and hand-woven kilims in place.",
      "One of the three great house museums in Mostar, with Kajtaz and Muslibegović.",
    ],
  },
  {
    slug: "muslibegovic-house",
    kicker: "Ottoman House",
    ...
    area: "Old city",
    details: [
      "A national monument with two courtyards, a hammam, and rooms layered in Ottoman and Austro-Hungarian detail.",
      "You can sleep here — the upper rooms are let as a boutique hotel with the museum below.",
      "Look for the collection of hand-written Qur'ans and the carved wooden ceilings.",
    ],
  },
  {
    slug: "old-bazaar-hammam",
    kicker: "Museum",
    ...
    area: "Old city",
    details: [
      "Star-shaped skylights pierce the domes and throw points of light across the cold marble.",
      "Built in the 16th century, abandoned for decades, and reopened after a 2010s restoration.",
      "Rotating exhibitions on Mostar crafts, photography, and city history.",
    ],
  },
  {
    slug: "spanish-square",
    ...
    area: "West bank",
    details: [
      "Named for the Spanish peacekeepers who died here; the restored Mostar Gymnasium anchors the square.",
      "The Gymnasium was a front-line ruin and is now a shared school — one of the clearest symbols of the city's repair.",
      "Cafés on Rondo and Kralja Petra spill out from here in the evening.",
    ],
  },
  {
    slug: "bulevar-front-line",
    ...
    area: "West bank",
    details: [
      "Bulevar Narodne Revolucije was the dividing line of the 1993 – 94 conflict; shell damage is still legible along it.",
      "The unfinished Ljubljanska Banka tower — the Sniper Tower — stands covered in graffiti and murals. Entry is unofficial and genuinely unsafe.",
      "Read it from the street: the contrast with the rebuilt old city is the point.",
    ],
  },
  {
    slug: "partisan-cemetery",
    kicker: "Monument",
    ...
    area: "West bank",
    details: [
      "Bogdan Bogdanović's cascading stone terraces, water channels, and glass-slab grave markers for 700 partisans.",
      "Overgrown and vandalised for years, now a protected national monument with slow restoration work under way.",
      "One of the strangest and most powerful spaces in Bosnia and Herzegovina — bring solid shoes.",
    ],
  },
  {
    slug: "blagaj-tekke",
    ...
    area: "Around Mostar",
    details: [
      "12 km southeast of Mostar: the Buna spring pours out of a karst cave at the base of the cliff, one of Europe's largest.",
      "The tekke has been a Sufi lodge since the 16th century; cover shoulders and knees and remove shoes inside.",
      "Trout restaurants line the river below — the classic Mostar lunch stop.",
    ],
  },
  {
    slug: "pocitelj",
    ...
    area: "Around Mostar",
    details: [
      "A fortified medieval and Ottoman settlement climbing the cliff: Šišman Ibrahim Pasha Mosque, the medresa, hammam, and clock tower.",
      "Climb the Gavrankapetanović fort for the bend of the Neretva; the stairs are steep and unrailed.",
      "Buy pomegranate juice and dried figs from the stalls at the bottom.",
    ],
  },
  {
    slug: "kravice-waterfalls",
    kicker: "Day Trip",
    ...
    area: "Around Mostar",
    details: [
      "Roughly 40 km southwest of Mostar, an amphitheatre of tufa falls dropping into a swimmable pool.",
      "A shuttle train runs down the slope from the car park; the walk back up is steep in the heat.",
      "Go early — by midday in August it is the busiest spot in Herzegovina.",
    ],
  },
];
